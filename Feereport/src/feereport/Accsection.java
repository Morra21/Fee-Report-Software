 ...
 * @author hp
 */
public class Accsection extends javax.swing.JFrame {

    /**
     * Creates new form Accsection
     */
    public Accsection() {
        initComponents();
    }
...
this.setVisible(false);
new Viewstable().setVisible(true);        // TODO add your handling code here:
...
new Viewdue().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Accsection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
