...
public class Acclogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String acpw=jPasswordField1.getText();
        
        try
        {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection c=DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/fees","root","idea");
            PreparedStatement p=c.prepareStatement("select * from acc_table where acid=? and acpw=?");
            p.setInt(1,acid);
            p.setString(2,acpw);
            ...
            {
                JOptionPane.showMessageDialog(this, "Incorrect id or password!","Login failed", JOptionPane.ERROR_MESSAGE);
            }
