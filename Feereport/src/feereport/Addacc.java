...
public class Addacc extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            String acname=jTextField2.getText();
            String acpw=jTextField3.getText();
            String acemail=jTextField4.getText();
            String accon=jTextField5.getText();
            try
            {
               Class.forName("com.mysql.cj.jdbc.Driver");
               Connection c=DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/fees","root","idea");
               PreparedStatement p=c.prepareStatement("insert into acc_table values (?,?,?,?,?)");
               
                p.setInt(1, acid);
                p.setString(2, acname);
                p.setString(3, acpw);
                p.setString(4, acemail);
                p.setString(5, accon);
                
                int i=p.executeUpdate();
           if(i>0)
           {
               JOptionPane.showMessageDialog(this,"Accountant added!","Successful",JOptionPane.INFORMATION_MESSAGE);
           }
                c.close();
